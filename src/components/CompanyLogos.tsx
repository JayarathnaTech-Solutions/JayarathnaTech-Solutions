...
const cardClass =
    'flex h-16 w-36 shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-white p-4 transition-colors hover:border-slate-300'
        ...
        <section className="mx-auto max-w-7xl px-6 py-12">
            <Reveal>
                ...
                <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                    {companies === null
                        ? [0, 1, 2, 3, 4].map((i) => (
                              <div key={i} className="h-16 w-36 shrink-0 animate-pulse rounded-lg bg-slate-100" />
                          ))
