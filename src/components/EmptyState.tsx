...
export function EmptyState({
    ...
    return (
        <div className="mt-8 flex flex-col items-center rounded-xl border border-slate-200 bg-white px-6 py-16 text-center dark:border-slate-700 dark:bg-slate-800/40">
