...
// Admin panel lives on its own subdomain (same Vercel project/deployment,
// routed by hostname in App.tsx) so it's never reachable from the public
// domain's URL bar.
export const ADMIN_URL = 'https://admin.jayarathnatechsolutions.com'
