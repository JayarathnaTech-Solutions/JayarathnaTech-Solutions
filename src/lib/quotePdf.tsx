...
const styles = StyleSheet.create({
    ...
    header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16, borderBottom: '1 solid #e2e8f0', paddingBottom: 10 },
    logo: { width: 130, height: 34 },
    brand: { fontSize: 15, fontFamily: 'Helvetica-Bold' },
    letterhead: { alignItems: 'flex-end' },
    letterheadBrand: { alignItems: 'flex-end', marginBottom: 6 },
    ...
    quoteTitle: { fontSize: 22, fontFamily: 'Helvetica-Bold', textAlign: 'center', letterSpacing: 2, marginBottom: 14 },
    ...
    tableHeader: { flexDirection: 'row', backgroundColor: '#f1f5f9', paddingVertical: 6, fontSize: 9, color: '#64748b' },
    colDescription: { flex: 3 },
    colQty: { flex: 1, textAlign: 'right' },
    colPrice: { flex: 1, textAlign: 'right' },
    colTotal: { flex: 1, textAlign: 'right' },
    summaryRow: { flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center', marginTop: 10, gap: 12 },
    summaryLabel: { fontSize: 10, color: '#64748b' },
    summaryValue: { fontSize: 10, color: '#0f172a', width: 70, textAlign: 'right' },
    totalRow: { flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center', marginTop: 6, gap: 12, borderTop: '1 solid #e2e8f0', paddingTop: 8 },
    ...
    signatureImage: { width: 120, height: 36, marginTop: 2, marginBottom: -6, objectFit: 'contain' },
