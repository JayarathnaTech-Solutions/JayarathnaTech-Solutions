...
export function ForceChangePasswordForm({ user, onChanged }: { user: User; onChanged: () => void }) {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-slate-950 px-6 text-white">
            <div className="w-full max-w-sm rounded-xl border border-slate-800 bg-slate-900/40 p-8">
                <h1 className="text-xl font-semibold">Set a new password</h1>
                <p className="mt-1.5 text-sm text-slate-400">You're using a temporary password — set your own to continue.</p>
