...
function LogoUpload({ value, onChange }: { value: string; onChange: (url: string) => void }) {
    ...
    return (
        <div>
            <label className="mb-1.5 block text-sm font-medium text-slate-600">Logo</label>
            <input
                ref={inputRef}
                type="file"
                accept="image/*"
            ...
            >
                {value && !uploading ? (
                    ...
                    <>
                        ...
                        <span className="text-sm text-slate-500">Drag & drop logo here, or click to browse</span>
                    </>
                )}
            </button>
                                ...
                                <tr key={company.id}>
                                    <td className="px-6 py-3">
                                        <div className="flex items-center gap-3">
                                            <div className="flex h-10 w-14 shrink-0 items-center justify-center overflow-hidden rounded bg-slate-200">
                                                {company.logoUrl && (
                                    ...
                                    <td className="px-6 py-3 text-slate-500">{formatDate(company.createdAt)}</td>
                                    <td className="px-6 py-3">
                                        <div className="flex justify-end gap-2">
                                            ...
                                            <button
                                                ...
                                                className="rounded-lg p-2 text-slate-500 hover:bg-red-500/10 hover:text-red-600"
                                            >
                                                <DeleteIcon />
                                            </button>
                                        </div>
