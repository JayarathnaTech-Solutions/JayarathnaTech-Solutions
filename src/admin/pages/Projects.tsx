...
function CoverImageUpload({
    ...
    return (
        <div>
            <label className="mb-1.5 block text-sm font-medium text-slate-600">Cover Image</label>
            <input
                ref={inputRef}
                type="file"
                accept="image/*"
            ...
            >
                {value && !uploading ? (
                    ...
                    <>
                        ...
                        <span className="text-sm text-slate-500">Drag & drop image here, or click to browse</span>
                    </>
                )}
            </button>
                        ...
                        <tbody className="divide-y divide-slate-200">
                            {projects.map((project) => (
                                <tr key={project.id}>
                                    ...
                                    <td className="px-6 py-3 text-slate-500">{project.category || '—'}</td>
                                    <td className="px-6 py-3 text-slate-500">{formatDate(project.createdAt)}</td>
                                    <td className="px-6 py-3">
