...
function ProjectCard({ project }: { project: Project }) {
    return (
        <MotionLink
            ...
            whileHover={{ y: -4 }}
            className="group overflow-hidden rounded-xl border border-slate-200 bg-white transition-colors hover:border-slate-300"
        >
            ...
            {projects !== null && projects.length > 0 && activeCategory === 'All' && hasMore && (
                <div className="mt-10 flex justify-center">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.97 }}
                        className="rounded-lg border border-slate-300 px-6 py-3 text-sm font-medium text-slate-900 transition-colors hover:border-slate-400 disabled:opacity-50"
                    >
